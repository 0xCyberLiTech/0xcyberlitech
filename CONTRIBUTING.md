# 🤝 Guide de contribution à 0xCyberLiTech

Merci de votre intérêt pour contribuer à ce laboratoire de cybersécurité et IT ! Voici les étapes et bonnes pratiques à suivre :
...
2. **Créez une branche** dédiée à votre contribution :
   ...
   ```
3. **Ajoutez vos modifications** (scripts, documentation, corrections, etc.).
4. **Respectez la structure** des dossiers et la nomenclature des fichiers.
5. **Testez** votre code ou vos scripts avant de proposer une modification.
